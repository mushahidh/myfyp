      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_4">
            <div class="title">
              <h4> <span>Add University</span> <span style="font-size:11px;">(Fields marked with * are required)</span></h4> 
            </div>
            <div class="content">
              ...
              %>
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="text" id="uni_name" name="uni_name"  placeholder="Enter university Name..." class="row-fluid" required onkeyup="javaScript:validate_uni_name();">
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="text" id="uni_address" name="uni_address"  placeholder="Enter university Address..." class="row-fluid" required>
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input id="curl" type="url" name="uni_website" required class="row-fluid"/>
                  </div>
                </div>
                  ...
                  <div class="controls span7">
                    <input type="text" id="with-tooltip" name="uni_desc"  placeholder="Enter university Description..." class="row-fluid" >
                  </div>
                </div>
