            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="">Name</th>
                  <th class="jv no_sort">Location</th>
                  <th class="jv no_sort">Address</th>
                  <th class="to_hide_phone ue no_sort">Website</th>
            ...
            %>
                <tr>
                  ...
                  <td class="to_hide_phone"><%= u.getUni_name() %></td>
                    <td class="to_hide_phone"><%= u.getUni_location() %></td>
                      <td class="to_hide_phone"><%= u.getUni_address() %></td>
                        <td class="to_hide_phone"><%= u.getUni_website() %></td>
                        <td class="to_hide_phone"><%= u.getUni_desc() %></td>
                         
                            
                 
              
                  <td class="ms"><div class="btn-group1"> <a href="edit_university.jsp?uni_id=<%= u.getUni_id() %>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a> <a class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="View"><i class="gicon-eye-open"></i></a> <a href="javascript:delete_uni('<%=u.getUni_id() %>')" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    function delete_uni(uni_id)
    {
    	   var cnfrm = confirm("Are you sure you want to delete this university?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_university_ac.jsp?uni_id='+uni_id;
    		}
    	}
</script>
</body>
