            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="ms"><div class="btn-group1"> <a href="edit_course.jsp?course_id=<%= c.getCourse_id() %>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a> <a class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="View"><i class="gicon-eye-open"></i></a> <a href="javascript:delete_course('<%= c.getCourse_id() %>')" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    function delete_course(course_id)
    {
    	   ...
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_course_ac.jsp?course_id='+course_id;
    		}
    	}
