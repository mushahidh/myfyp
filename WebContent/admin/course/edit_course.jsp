      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_4">
            <div class="title">
              <h4> <span>Edit Course</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" method="get" action="../../course_controller" onsubmit="javaScript: return validate();" autocomplete="off">
              <%
                    	courseDAO UD=new courseDAO();
                        String idd=request.getParameter("course_id");
                        int id=Integer.parseInt(idd);
                        course c=UD.getCourseInfo(id);
                    %>
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Course Name*</label>
                  <div class="controls span7">
                    <input type="text" id="course_name" name="course_name" value="<%=c.getCourse_name()%>"  placeholder="Enter Course Name..." class="row-fluid" required onkeyup="javaScript:validate_course_name();">
