      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_7">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Add Includes</span> <span style="font-size:11px;">(Fields marked with * are required)</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" action="../../group_includes_controller">
              ...
              %>
               <div class="form-row control-group row-fluid">
                  <label class="control-label span3">Select Group * </label>
                  <div class="controls span7">
                    <select data-placeholder="Choose a Group..." class="chzn-select" name="group_id" id="group_id" required onChange="javaScript:validate_field();">
                      <option value=""></option>
                       <%
				...
				for(int i=0;i<GI.size();i++)
				{
					g=(group)GI.get(i);
            %>
                      <option value="<%=g.getGroup_id()%>"><%=g.getGroup_name()%></option>
         	  <%} %> 
                ...
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="inputEmail">Select field *</label>
                  <div class="controls span7">
                    <select data-placeholder="Choose a field" class="chzn-select" multiple="" tabindex="3" name="field_id" id="field_id" required onChange="javaScript:validate_course();">
               <%
...
<script type="text/javascript">
 ...
 $(document).ready(function () {
	...
	function validate()
	{
		if(validate_field()==true&&validate_course()==true)
			{
			 	return true;
			}
		return false;
