            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="">Field</th>
                  <th class="jv no_sort">Includes</th>
              ...
              <tbody>
                ...
                fieldDAO FD=new fieldDAO();
             	groupIncludesDAO ID=new groupIncludesDAO();
     	ArrayList<groupIncludes> EI=new ArrayList<groupIncludes>();
     	EI=ID.retrieveGroupIncludesInfo();
     	group g=null;
     	field f=null;
     	groupIncludes in=null;
     	for(int i=0;i<EI.size();i++)
     	{
			in=(groupIncludes)EI.get(i);
     		g=GD.getGroupInfo(in.getGroup_id());
            f=FD.getFieldInfo( in.getField_idd());
                 %>
                <tr>
                 
             
                  <td class="to_hide_phone"><%= g.getGroup_name() %></td>
                  ...
                  <td class="ms"><div class="btn-group1">  <a href="javascript:delete_Groupincludes('<%= in.getGroup_id() %>','<%= in.getField_idd() %>');" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    function delete_Groupincludes(group_id,field_id)
    {
    	   var cnfrm = confirm("Are you sure you want to delete this include?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_group_includes_ac.jsp?group_id='+group_id+'&field_idd='+field_id;
    		}
    	}
</script>
</body>
