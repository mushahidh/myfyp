            ...
            %>
                <tr>
                  ...
                  <td class="to_hide_phone"><%= f.getField_name() %></td>
                        <td class="to_hide_phone"><%= f.getField_desc() %></td>
                        <td class="to_hide_phone"><%= f.getField_standard() %></td>
                         
                            
                 
              
                  <td class="ms"><div class="btn-group1"> <a href="edit_field.jsp?field_id=<%= f.getField_id() %>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a> <a class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="View"><i class="gicon-eye-open"></i></a> <a href="javascript:delete_field('<%= f.getField_id() %>')" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    {
    	   var cnfrm = confirm("Are you sure you want to delete this field?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_field_ac.jsp?field_id='+field_id;
    		}
    	}
</script>
</body>
