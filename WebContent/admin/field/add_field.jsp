      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_4">
            <div class="title">
              <h4> <span>Add Field</span> <span style="font-size:11px;">(Fields marked with * are required)</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" method="get" onsubmit="javaScript: return validate();" action="../../field_controller" autocomplete="off">
              ...
              %>
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="text" id="field_name" name="field_name"  placeholder="Enter Field Name..." class="row-fluid" required onkeyup="javaScript:validate_field_name();">
                  	<label id="field_name_info"  style="color:rgba(255,255,255,0.6);font-size:13px">
  					  </label>
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="default-select">Select Field Standard</label>
                  <div class="controls span7">
                    <select data-placeholder="Select Standard..." class="chzn-select" id="default-select" name="field_standard">
                      <option value=""></option>
                  ...
                  <div class="controls span7">
                    <input type="text" id="with-tooltip" name="field_desc"  placeholder="Enter Field Description..." class="row-fluid" >
                  </div>
                </div>
