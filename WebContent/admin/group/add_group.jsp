      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_4">
            <div class="title">
              <h4> <span>Add Group</span> <span style="font-size:11px;">(Fields marked with * are required)</span></h4>
            </div>
            <div class="content">
              ...
              %>
                 ...
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Group Name*</label>
                  <div class="controls span7">
                    <input type="text" id="group_name" name="group_name"  placeholder="Enter Group Name..." class="row-fluid" required onkeyup="javaScript:validate_group_name();">
