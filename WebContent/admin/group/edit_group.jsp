      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_4">
            <div class="title">
              <h4> <span>Edit Group</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" method="get" action="../../group_controller" onsubmit="javaScript: return validate();" autocomplete="off">
              <%
                    	groupDAO GD=new groupDAO();
                        String idd=request.getParameter("group_id");
                        int id=Integer.parseInt(idd);
                        group g=GD.getGroupInfo(id);
                    %>
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Course Name*</label>
                  <div class="controls span7">
                    <input type="text" id="group_name" name="group_name" value="<%=g.getGroup_name()%>"  placeholder="Enter Course Name..." class="row-fluid" required  onkeyup="javaScript:validate_group_name();">
                 <input type="hidden"  name="group_id" value="<%=g.getGroup_id()%>"  >
                 <label id="group_name_info"  style="color:rgba(255,255,255,0.6);font-size:13px">
  					  </label>
                  </div>
                </div>
              <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="default-select">Select Group Standard</label>
                  <div class="controls span7">
                    <select data-placeholder="Select Grade..." class="chzn-select" id="default-select" name="group_standard">
                      <option value="<%=g.getGroup_standard()%>"><%=g.getGroup_standard()%></option>
...
function validate_group_name(){
	 ...
	 var TCode = document.getElementById('group_name').value;
	    if( /[^a-zA-Z1-9 _-]/.test( TCode ) ) {
	    	
	    	group_name_info.innerHTML="Please Enter Only Alphanumeric or _,-,' '  ";
	       return false;
	    }
	    group_name_info.innerHTML=" ";
	    return true;  
