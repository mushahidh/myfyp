              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="to_hide_phone"><%= g.getGroup_name() %></td>
                   <td class="to_hide_phone"><%= g.getGroup_standard() %></td>
                        
                         
                            
                 
              
                  <td class="ms"><div class="btn-group1"> <a href="edit_group.jsp?group_id=<%= g.getGroup_id() %>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a> <a class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="View"><i class="gicon-eye-open"></i></a> <a href="javascript:delete_group('<%= g.getGroup_id() %>')" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    {
    	   var cnfrm = confirm("Are you sure you want to delete this course?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_group_ac.jsp?group_id='+group_id;
    		}
    	}
