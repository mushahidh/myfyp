        ...
        <div class="box ">
         <div class=" box paint color_25">
          ...
          <div class="content top">
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="">Field</th>
                  <th class="jv no_sort">Required</th>
        	...
        	eligibilityDAO ED=new eligibilityDAO();
			ArrayList<eligibility> EI=new ArrayList<eligibility>();
			EI=ED.retrieveEligibilityInfo();
			field ef=null;
			field er=null;
			eligibility e=null;
			for(int i=0;i<EI.size();i++)
			{
				e=(eligibility)EI.get(i);
				ef=FD.getFieldInfo(e.getField_id());
				er=FD.getFieldInfo( e.getRequired_idd());
            %>
                <tr>
                 
             
                  <td class="to_hide_phone"><%= ef.getField_name() %></td>
                    <td class="to_hide_phone"><%= er.getField_name() %></td>
                     
                         
                            
                 
              
                  <td class="ms"><div class="btn-group1">  <a href="javascript:delete_eligibility('<%= e.getField_id() %>','<%=e.getRequired_idd() %>');" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    function delete_eligibility(field_id,required_id)
    {
    	   var cnfrm = confirm("Are you sure you want to delete this eligibility?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_eligibility_ac.jsp?field_id='+field_id+'&required_idd='+required_id;
    		}
    	}
</script>
</body>
