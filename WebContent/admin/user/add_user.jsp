      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_4">
            ...
            <div class="content">
              <form  class="form-horizontal cmxform" id="validateForm" method="post" onsubmit="javaScript: return validate();" action="../../user_controller" autocomplete="off" enctype="multipart/form-data">
              ...
              %>
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="text"  id="first_name" name="user_first_name"  placeholder="Enter First Name..." class="row-fluid" required onkeyup="javaScript:validate_first_name();">
                  ...
                  <div class="controls span7">
                    <input type="text" id="last_name" name="user_last_name"  placeholder="Enter Last Name..." class="row-fluid" onkeyup="javaScript:validate_last_name();">
             ...
             <div class="form-row control-group row-fluid">
                ...
                <div class="control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="text" name="user_screen_name" id="screen_name" rel="tooltip" data-placement="top" data-original-title="This name will be visible to other Users" placeholder="Enter Screen Name..." class="row-fluid" required onkeyup="javaScript:validate_screen_name();">
                 ...
                 <div class="form-row control-group row-fluid ">
                  <label class="control-label span3" for="mask-phone">Cell Number <span class="help-block">(300) 534-2222</span> </label>
                  <div class="controls span7">
                    <input id="mask-phone" name="user_cell_number" type="text" tabindex="3" class="row-fluid">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3">Date Of Birth</label>
                  <div class="controls span7">
                    <input type="text" name="user_DOB" id="datepicker1" value="02-16-1992" class="row-fluid">
                  </div>
                </div>
            <div class="form-row control-group row-fluid">
