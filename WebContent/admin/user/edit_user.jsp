      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_4">
            <div class="title">
              <h4> <span>Edit User</span>  <span style="font-size:11px;">(Fields marked with * are required)</span></h4>
            </div>
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" onsubmit="javaScript: return validate();" method="post" action="../../user_controller" autocomplete="off" enctype="multipart/form-data">
                <%
        				userDAO UD=new userDAO();
     	 				String idd=request.getParameter("user_id");
     					int id=Integer.parseInt(idd);
						user u=UD.getUserInfo(id);
        		 %>
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">First Name*</label>
                  <div class="controls span7">
                    <input type="text" id="first_name" name="user_first_name" value="<%=u.getUser_first_name() %>"  placeholder="Enter First Name..." class="row-fluid" required onkeyup="javaScript:validate_first_name();">
                    <input type="hidden"  name="user_id" value="<%=u.getUser_id() %>">
                 	<label id="first_name_info"  style="color:rgba(255,255,255,0.6);font-size:13px">
  					  </label>
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Last Name</label>
                  <div class="controls span7">
                    <input type="text" id="last_name" name="user_last_name" value="<%=u.getUser_last_name() %>"  placeholder="Enter Last Name..." class="row-fluid" onkeyup="javaScript:validate_last_name();">
                  <label id="last_name_info"  style="color:rgba(255,255,255,0.6);font-size:13px">
  					  </label>
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                   <%if(u.getUser_gender().equals("Male"))
                    {%>
                	 <fieldset>
                       ...
                       <label for="user_gender" class="error">Please select your gender</label>
                     </fieldset>
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    ...
                    <select data-placeholder="Choose a City..." class="chzn-select" name="user_city" id="user_city"  required onChange="javaScript:validate_user_city();">
                      <option value="<%=u.getUser_city() %>" selected><%=u.getUser_city() %></option>
                   ...
                   <label id="user_city_info"  style="color:rgba(255,255,255,0.6);font-size:13px">
             ...
             <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7 ">
                    <div class="input-prepend row-fluid"> <span class="add-on"><i class="icon-lock"></i></span>
                      <input class="row-fluid" type="password" value="<%=u.getUser_encrypted_password() %>"  name="user_password" id="password" placeholder="min 5 characters">
                    </div>
                  </div>
                </div>
                <div class="control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <div class="input-prepend row-fluid"> <span class="add-on"><i class="icon-lock"></i></span>
                      <input class="row-fluid" type="password" id="confirm_password" value="<%=u.getUser_encrypted_password() %>" placeholder="confirm password" name="user_confirm_password">
                    </div>
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="text" name="user_screen_name" value="<%=u.getUser_screen_name() %>" id="screen_name" rel="tooltip" data-placement="top" data-original-title="This name will be visible to other Users" placeholder="Enter Screen Name..." class="row-fluid" required onkeyup="javaScript:validate_screen_name();">
                  <label id="screen_name_info"  style="color:rgba(255,255,255,0.6);font-size:13px">
  					  </label>
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="email" name="user_email" id="email" value="<%=u.getUser_email() %>" placeholder="Enter Email..."  class="row-fluid"  required>
                  </div>
                </div>
                 <div class="form-row control-group row-fluid ">
                  <label class="control-label span3" for="mask-phone">Cell Number <span class="help-block">(999) 999-9999</span> </label>
                  <div class="controls span7">
                    <input id="mask-phone" name="user_cell_number" value="<%=u.getUser_cell_number() %>" type="text" tabindex="3" class="row-fluid">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3">Date Of Birth</label>
                  <div class="controls span7">
                    <input type="text" name="user_DOB"  value="<%=u.getUser_DOB() %>" id="datepicker1" value="02-16-2012" class="row-fluid">
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
...
function validate_user_city(){
	...
	function validate()
	{
		if(validate_user_city()==true&&validate_first_name()==true&&validate_last_name()==true&&validate_screen_name()==true)
			{
			 	return true;
			}
		return false;
