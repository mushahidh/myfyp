          ...
          <div class="content top">
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="to_hide_phone ue no_sort">Screen Name</th>
                  <th class="to_hide_phone  no_sort">Email</th>
                  <th class="to_hide_phone no_sort">Gender</th>
            ...
            %>
                <tr>
                  ...
                  <td><img style="height:50px; width:50px;" class="thumbnail small"  src="../../image?id=<%=u.getUser_id()%>" /></td>
                  <td class="to_hide_phone"><%= u.getUser_first_name() %></td>
                    <td class="to_hide_phone"><%= u.getUser_last_name() %></td>
                      <td class="to_hide_phone"><%= u.getUser_screen_name() %></td>
                        <td class="to_hide_phone"><%= u.getUser_email() %></td>
                          <td class="to_hide_phone"><%= u.getUser_gender() %></td>
                            
                 
              
                  <td class="ms"><div class="btn-group1"> <a href="edit_user.jsp?user_id=<%= u.getUser_id() %>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a> <a class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="View"><i class="gicon-eye-open"></i></a> <a href="javascript:delete_user('<%=u.getUser_id() %>')" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    {
    	   var cnfrm = confirm("Are you sure you want to delete the user?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_user_ac.jsp?user_id='+user_id;
    		}
    	}
</script>
</body>
