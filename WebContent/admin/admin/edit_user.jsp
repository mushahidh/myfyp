      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_4">
            ...
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" method="post" action="../../user_controller" autocomplete="off" enctype="multipart/form-data">
                <%
        				adminDAO UD=new adminDAO();
     	 				String idd=request.getParameter("user_id");
     	 				System.out.println(idd);
     					int id=Integer.parseInt(idd);
     					admin u=UD.getUserInfo(id);
        		 %>
             ...
             <div class="form-row control-group row-fluid">
                ...
                <div class="control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="text" name="user_screen_name" value="<%=u.getUser_screen_name() %>" id="with-tooltip" rel="tooltip" data-placement="top" data-original-title="This name will be visible to other Users" placeholder="Enter Screen Name..." class="row-fluid" required>
                  </div>
                </div>
                  <div class="form-row control-group row-fluid">
              ...
              <div class="form-actions row-fluid">
                  <div class="span7 offset3">
                    <button type="submit" name="user_action" value="edit" class="btn btn-primary" onClick="javaScript:validate_user_city();">Save</button>
