      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_7">
            ...
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" action="../../includes_controller">
            ...
            %>
         	  ...
         	  <%} %> 
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <select data-placeholder="Choose a course" class="chzn-select" multiple="" tabindex="3" name="course_id" id="course_id" required onChange="javaScript:validate_course();">
               <%
