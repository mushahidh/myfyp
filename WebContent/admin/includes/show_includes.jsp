            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="ms"><div class="btn-group1">  <a href="javascript:delete_includes('<%= in.getField_id() %>','<%= in.getCourse_idd() %>');" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    function delete_includes(field_id,course_id)
    {
    	   var cnfrm = confirm("Are you sure you want to delete this include?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_includes_ac.jsp?field_id='+field_id+'&course_idd='+course_id;
    		}
    	}
</script>
</body>
