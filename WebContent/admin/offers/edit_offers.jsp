...
.text
{
  ...
  <%
        				offersDAO OD=new offersDAO();
     	 				...
     	 				String uni_idd=request.getParameter("uni_id");
     					int uni_id=Integer.parseInt(uni_idd);
     					String field_idd=request.getParameter("field_id");
     					int field_id=Integer.parseInt(field_idd);
						
						universityDAO UDD=new universityDAO();
						university U=UDD.getUniversityInfo(uni_id);
						
						fieldDAO FD=new fieldDAO();
						field f=FD.getFieldInfo(field_id);
						offers o=OD.getOffersInfo(uni_id, field_id);
      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_7">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Edit Offering</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" action="../../offers_controller">
              
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3">University</label>
                  <div class="controls span7">
                      <input type="text" disabled value="<%=U.getUni_name() %>" class="row-fluid"/>
                       <input type="hidden" value="<%=o.getUni_id() %>" name="uni_id" />
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                      <input type="text" disabled value="<%=f.getField_name() %>" class="row-fluid"/>
                       <input type="hidden" value="<%=o.getField_idd() %>" name="field_id" />
                  </div>
                </div>
                   <div class="form-row control-group row-fluid">
