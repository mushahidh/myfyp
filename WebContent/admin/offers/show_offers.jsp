      ...
      <div class="row-fluid">
        <div class="box ">
         <div class=" box paint color_25">
          <div class="title">
            <h4> Universities Programs Offering Criteria</h4>
          </div>
          <!-- End .title -->
          ...
          <div class="content top">
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="">Uni Name</th>
                  <th class="">Field Name</th>
                  <th class="">Hssc Criteria</th>
                  <th class="">Ssc Criteria</th>
			...
			for(int i=0;i<OI.size();i++)
			{
				o=(offers)OI.get(i);
				uni_id= o.getUni_id();
				field_id=o.getField_idd();
				university U=UD.getUniversityInfo(uni_id);
				field f=FD.getFieldInfo(field_id);
            %>
                <tr>
                 
                  <td class="to_hide_phone"><%= U.getUni_name() %></td>
                        <td class="to_hide_phone"><%= f.getField_name() %></td>
                         <td class="to_hide_phone"><%= o.getHssc_criteria() %></td>
                          <td class="to_hide_phone"><%= o.getSsc_criteria() %></td>
                           <td class="to_hide_phone"><%= o.getDuration() %></td>
                         
                            
                 
              
                  <td class="ms"><div class="btn-group1"> <a href="edit_offers.jsp?uni_id=<%= o.getUni_id() %>&field_id=<%=o.getField_idd() %>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a> <a class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="View"><i class="gicon-eye-open"></i></a> <a href="javascript:delete_offer('<%=o.getUni_id() %>','<%=o.getField_idd() %>');" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    function delete_offer(uni_id,field_id)
    {
    	   var cnfrm = confirm("Are you sure you want to delete this offering?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_offers_ac.jsp?uni_id='+uni_id+'&field_id='+field_id;
    		}
    	}
</script>
</body>
