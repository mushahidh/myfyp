        ...
        <div class="box ">
         <div class=" box paint color_24">
          ...
          <div class="content top">
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="">Name</th>
                  <th class="jv no_sort">Realistic</th>
                  <th class="jv no_sort">Investigative</th>
                  <th class="to_hide_phone ue no_sort">Artistic</th>
                  <th class="to_hide_phone  no_sort">Social</th>
                  <th class="to_hide_phone  no_sort">enterprising</th>
                  <th class="to_hide_phone  no_sort">conventional</th>
			...
			ArrayList<interest> UI=new ArrayList<interest>();
			UI=ID.retrieveInterestInfo();
			interest i=null;
			...
			{
				i=(interest)UI.get(j);
				field f=FD.getFieldInfo(i.getField_id());
            %>
                <tr>
                 
                 
                  <td class="to_hide_phone"><%= f.getField_name() %></td>
                    <td class="to_hide_phone"><%= i.getRealistic() %></td>
                     <td class="to_hide_phone"><%= i.getInvestigative() %></td>
                 	 <td class="to_hide_phone"><%= i.getArtistic() %></td>
                        <td class="to_hide_phone"><%= i.getSocial() %></td>
                        <td class="to_hide_phone"><%= i.getEnterprising() %></td>
                        <td class="to_hide_phone"><%= i.getConventional() %></td>
                         
                            
                 
              
                  <td class="ms">  <div class="btn-group1"> <a href="edit_interest.jsp?field_id=<%= i.getField_id() %>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a><a href="javascript:delete_interest('<%=i.getField_id() %>')" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
Modal Concept 
<script language="javascript" type="text/javascript" src="../../resources/js/plugins/avgrund.js"></script> 
...
<!-- Data tables plugin --> 
<script type="text/javascript" language="javascript" src="../../resources/js/plugins/datatables/js/jquery.dataTables.js"></script> 
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    function delete_interest(field_id)
    {
    	   var cnfrm = confirm("Are you sure you want to delete this interest?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_interest_ac.jsp?field_id='+field_id;
    		}
    	}
</script>
</body>
