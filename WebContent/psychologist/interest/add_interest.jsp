      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_24">
            <div class="title">
              <h4> <span>Add Interest</span> </h4>
            </div>
            <div class="content">
              <form class="form-horizontal cmxform" id="validateForm" onsubmit="javaScript: return validate();" method="get" action="../../interest_controller" autocomplete="off">
