      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_24">
            <div class="title">
              <h4> <span>Add Question</span>  <span style="font-size:11px;">(Fields marked with * are required)</span></h4>
            </div>
            <div class="content">
              ...
              %>
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span7">
                    <input type="text" id="with-tooltip" name="question"  placeholder="Enter Question..." class="row-fluid" required>
                  </div>
                </div>
              ...
              <div class="form-actions row-fluid">
                  <div class="span7 offset3">
                    <button type="submit" name="user_action" value="add" class="btn btn-primary" onClick="javaScript:validate_type();" >Save</button>
