      ...
      <div class="row-fluid">
        <div class="span7">
          <div class="box paint color_24">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Add Affect</span>  <span style="font-size:11px;">(Fields marked with * are required)</span></h4>
            </div>
            <div class="content">
            ...
            %>
         	  ...
         	  <%} %> 
                ...
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="inputEmail">Select courses</label>
                  <div class="controls span7">
                    <select data-placeholder="Choose a course" class="chzn-select"  name="course_id" id="course_id" required onChange="javaScript:validate_course();">
              <option value=""></option>
               <%
               	courseDAO CD=new courseDAO();
                ArrayList<course> CI=new ArrayList<course>();
                CI=CD.retrieveCourseInfo();
                course c=null;
         	  ...
         	  <%} %>    
                     ...
                     <label id="course_info"  style="color:rgba(255,255,255,0.6);font-size:13px"></label> 
                  </div>
                </div>
                     <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="with-tooltip">Weight*</label>
                  <div class="controls span7">
                    <input type="text" id="weight_id" name="weight"  placeholder="Enter weight..." class="row-fluid"  onkeyup="javaScript:validate_weight();">
	...
	function validate_weight(){
		 ...
		 if(weight==""){
		    ...
		    if( /[^1-9]/.test( weight) ) {
		    	...
		    	weight_info.innerHTML="Please Enter Only numeric data ";
		       return false;
		    }
