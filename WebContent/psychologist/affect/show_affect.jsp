            ...
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              <thead>
                <tr>
                  ...
                  <th class="">Field</th>
                  <th class="jv no_sort">Affect</th>
                  <th class="jv no_sort">Weight</th>
              ...
              <tbody>
                 <%
                 	fieldDAO FD=new fieldDAO();
                                                                                                                                        	...
                                                                                                                                        	{
                                                                                                                    		a=(affect)AI.get(i);
                                                                                                                                        		f=FD.getFieldInfo(a.getField_id());
                                                                                                                                        		c=CD.getCourseInfo( a.getCourse_id());
                 %>
                <tr>
                 
             
                  <td class="to_hide_phone"><%= f.getField_name() %></td>
                    <td class="to_hide_phone"><%=c.getCourse_name() %></td>
                    <td class="to_hide_phone"><%=a.getWeight() %></td>
                     
                         
                            
                 
              
                  <td class="ms"> <div class="btn-group1"> <a href="edit_affect.jsp?field_id=<%= a.getField_id() %>&course_id=<%= a.getCourse_id() %>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a> <a href="javascript:delete_affect('<%= a.getField_id() %>','<%= a.getCourse_id() %>');" class="btn  btn-small" rel="tooltip" data-placement="bottom" data-original-title="Remove"><i class="gicon-remove "></i></a> </div></td>
                </tr>
               <%} %> 
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  // Datatables
    ...
    function delete_affect(field_id,course_id)
    {
    	   var cnfrm = confirm("Are you sure you want to delete this association?");
    	   if(cnfrm)
    	   {
    		   window.location = 'delete_affect_ac.jsp?field_id='+field_id+'&course_id='+course_id;
    		}
    	}
</script>
</body>
